"""
Django settings for test_app_for_tkxel_44526 project.
...
ROOT_URLCONF = 'test_app_for_tkxel_44526.urls'
...
WSGI_APPLICATION = 'test_app_for_tkxel_44526.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_for_tkxel_44526 API",
    "DESCRIPTION": "API documentation for test_app_for_tkxel_44526 App",
    "VERSION": "v1",
}
